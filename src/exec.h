 ...
 */
#define NAME_STRICT_TYPES   0x1 /* Compiled with type testing */
#define NAME_PROTOTYPE      0x2 /* Defined by a prototype only */
#define NAME_HIDDEN         0x4 /* Not visible for inheritance [variables] */
...
struct function {
    ...
    /* -1 in an unsigned short? I made it signed. /Dark */
    short num_arg;	        /* Number of arguments needed.
...
struct internal_program {
    ...
    int heart_beat_index;		/* Index of the heart beat function.
					 * -1 means no heart beat
					 */
    int heart_beat_prog;                /* Index of heart beat function,
                                         * in the inherit list. 
                                         * -1 means this program.
                                         */
    /*
