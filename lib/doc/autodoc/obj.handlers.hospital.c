...
.SH Includes
.SP 5 5
This class includes the following files /include/armoury.h, /include/data.h and /include/weather.h.
.EP
...
The alignment produced will be within the range[ average - range, average + range ]
.EP
.SI 7
%^BOLD%^Parameters:%^RESET%^
.EI
.SP 9 5
average - The average alignment for this npc
.EP
.SP 9 5
range - The range request for alignment - the difference between
