...
.SH Inherits
.SP 5 5
This class inherits the following classes /std/living/skills, /std/living/nationality, /std/living/carrying, /std/living/respond_cmd, /std/living/holding, /std/container, /std/living/stats, /std/living/health, /std/living/combat, /std/living/armour, /std/living/gender, /std/living/money, /std/living/crafts, /std/living/spells and /std/living/force.
.EP
