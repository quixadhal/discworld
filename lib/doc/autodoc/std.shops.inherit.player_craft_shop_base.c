...
.SH Inherits
.SP 5 5
This class inherits the following classes /std/shops/inherit/person_expressions, /std/shops/inherit/expression_util, /std/shops/inherit/craft_shop_category and /std/shops/inherit/object_expressions.
.EP
...
.EI
.SP 9 5
amount - the amount to adjust it by
...
.SI 3
* %^BOLD%^do_category_description%^RESET%^
.EI
.SI 5
...
.SI 3
* %^BOLD%^do_category_information%^RESET%^
.EI
.SI 5
...
.SI 3
* %^BOLD%^do_expression_status%^RESET%^
.EI
.SI 5
...
.EI
.SP 9 5
person - the person to check if they are a helper
.EP
.SI 7
%^BOLD%^Returns:%^RESET%^
.EI
.SP 9 5
1 if they are a helper, 0 if not
...
.SI 3
* %^BOLD%^query_expression_status%^RESET%^
.EI
.SI 5
...
.EI
.SP 9 5
a string with the expression status in it
...
.EI
.SP 9 5
the string representation of the weekly stats
...
.SI 3
* %^BOLD%^inform_of_approved_item%^RESET%^
.EI
.SI 5
void inform_of_approved_item(string name, int cost, class approval_obs approve)
.EI
.SP 7 5
...
.EI
.SP 9 5
name - the name of the peron doing the approval
.EP
.SP 9 5
cost - the cost it ws approved for
.EP
.SP 9 5
approve - the approval class

.EP

.SI 3
* %^BOLD%^inform_of_rejected_item%^RESET%^
.EI
.SI 5
void inform_of_rejected_item(string name, class approval_obs approve)
.EI
.SP 7 5
...
.EI
.SP 9 5
name - the name of the peron doing the rejection
.EP
.SP 9 5
approve - the approval class
